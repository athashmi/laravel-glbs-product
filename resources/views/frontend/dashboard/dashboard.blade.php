...
<div class="row">
    <div class="col-sm-6 m-b-10">
        <div class="ar-1-1">
            <div class="widget-2 card no-border bg-primary widget widget-loader-circle-lg no-margin" style="">
                <div class="card-header ">
                    <div class="card-controls">
                        <ul>
            ...
            <div class="card-body">
                <div class="pull-bottom bottom-left bottom-right padding-25">
                    <span class="label font-montserrat fs-11">Notification</span>
                    <br>
                    <h3 class="text-white"><a class="color-white"href="javascript:void(0)"  data-target="#modalFillIn" data-id = "{{@$blog_post->id}}" data-toggle="modal">{{@$blog_post->title}}</a></h3>
                    <p class=" color-white text-white hint-text d-none d-lg-block d-xl-block d-none d-lg-block d-xl-block">{{substr(@$blog_post->summary, 0, 100)}}...</p>
                </div>
            </div>
        </div>
    </div>
...
<style type="text/css">
@if(@$blog_post->img_name)
    .widget-2:after{
    background-image: url({{route('img_file',$blog_post->img_name)}}) !important;
}
@else
 .widget-2:after{
...
@include('frontend.dashboard.dashboard-modal.notification-modal')
@endsection