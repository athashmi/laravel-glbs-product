        ...
        <div class="dropdown-menu dropdown-menu-right b-none contact-menu">
            ...
            <a class="dropdown-item"href="javascript:void(0)"  data-toggle="modal" data-id="{{$result->id}}" data-target="#{{$modal_id}}"><i class="icofont icofont-edit"></i>Add Actual Weight</a>
