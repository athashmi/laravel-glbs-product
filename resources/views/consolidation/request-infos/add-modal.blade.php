<!-- Model for create Country -->
    <div class="modal fade  stick-up" id="add_request_infos_model" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">

        <h4 class="modal-title pull-left" id="myModalLabel">Create Request Info</h4>
      ...
      <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input placeholder="Description" value="{{old('iso')}}" id="iso" class="form-control" name="description" type="text"> 
                </div>
...
<script>
  function createCountry() {
      $.ajax({
          type: "POST",
          url: "{{route('consolidation.request_info.store')}}",
          ...
          if(response.status == 1)
          {
            responseMsg("insert",'{{asset('images/icons8-ok-filled-480.png')}}');
              $('#add_request_infos_model').modal('hide');
