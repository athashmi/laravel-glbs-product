    ...
    <div class="modal fade stick-up" id="edit_address_model"  role="dialog" aria-labelledby="basicModal" aria-hidden="true">
...
$('#edit_address_model').on('shown.bs.modal', function (e) {
        ...
        $.get('{{URL::route("shopaholic.editshopaholicaddres")}}',{'id':id},function(response) {
...
function editAdress() {
      $.ajax({
        type: "POST",
        url: "{{URL::route('shopaholic.update_shopaholic_profile_address')}}",
