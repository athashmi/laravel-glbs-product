!function (a) {
  ...
  'function' != typeof Array.prototype.filter && (Array.prototype.filter = function (a) {
    ...
    for (var d = [
    ], e = arguments.length >= 2 ? arguments[1] : void 0, f = 0; c > f; f++) if (f in b) {
      var g = b[f];
  ...
  g = function () {
    ...
    k = function (c, e) {
      ...
      return f.reduce(function (a, c) {
        var d = b(a);
        return e(b(d), c) ? d[d.length] = c : a[a.length] = [
          c
        ],
        a
      }, [
    ...
    m = function (a) {
      for (var b = [
      ], c = 0, d = a.length; d > c; c++) - 1 === b.indexOf(a[c]) && b.push(a[c]);
      return b
    };
    return {
      head: a,
  ...
  o = function () {
    ...
    d = function (b, h, i, k) {
      ...
      this.insertNode = function (a, b) {
        ...
        h = f.getStartPoint();
        if (b) d = j.isPara(h.node) ? h.node : h.node.parentNode,
        e = j.isPara(h.node) ? h.node.childNodes[h.offset] : j.splitTree(h.node, h);
         else {
  ...
  p = function () {
    ...
    this.insertParagraph = function () {
      ...
      var c = j.ancestor(b.sc, j.isPara),
      d = j.splitTree(c, b.getStartPoint()),
      e = j.listDescendant(c, j.isEmptyAnchor);
      e = e.concat(j.listDescendant(d, j.isEmptyAnchor)),
  ...
  q = function () {
    ...
    this.createTable = function (b, c) {
      for (var d, e = [
      ], f = 0; b > f; f++) e.push('<td>' + j.blank + '</td>');
      d = e.join('');
      for (var g, h = [
      ], i = 0; c > i; i++) h.push('<tr>' + d + '</tr>');
      return g = h.join(''),
    ...
    this.releaseList = function (b, c) {
      ...
      return a.each(b, function (b, e) {
        ...
        a.each(m, function (b, c) {
          var d = [
            c
          ].concat(j.listDescendant(c, j.isList));
  ...
  s = function () {
    ...
    for (var i = this.afterCommand = function (a) {
      ...
      'fontName'
    ], m = 0, s = k.length; s > m; m++) this[k[m]] = function (a) {
      return function (b, c) {
  ...
  var z = function () {
    ...
    r = {
      ...
      showImageDialog: function (a) {
        ...
        c = a.editable();
        h.saveRange(c),
        o.showImageDialog(c, b).then(function (a) {
          h.restoreRange(c),
          'string' == typeof a ? h.insertImage(c, a)  : q(c, a)
        }).fail(function () {
          h.restoreRange(c)
        })
      },
      showVideoDialog: function (a) {
        ...
        d = h.getVideoInfo(c);
        h.saveRange(c),
        o.showVideoDialog(c, b, d).then(function (a) {
          h.restoreRange(c),
          h.insertVideo(c, a)
        }).fail(function () {
          h.restoreRange(c)
      ...
      codeview: function (a) {
        ...
        o ? (l.val(j.html(h, !0)), l.height(h.height()), i.deactivate(g), k.hide(m), l.focus(), e.hasCodeMirror && (c = b.fromTextArea(l[0], n.codemirror), n.codemirror.tern && (d = new b.TernServer(n.codemirror.tern), c.ternServer = d, c.on('cursorActivity', function (a) {
          d.updateArgHints(a)
        })), c.setSize(null, h.outerHeight()), l.data('cmEditor', c)))  : (e.hasCodeMirror && (c = l.data('cmEditor'), l.val(c.getValue()), c.toTextArea()), h.html(j.value(l) || j.emptyPara), h.height(n.height ? l.height()  : 'auto'), i.activate(g), h.focus()),
        i.updateCodeview(a.toolbar(), o)
      }
    },
    u = function (a) {
    ...
    this.attach = function (a, b) {
      ...
      b.airMode || (J(a, b.disableDragAndDrop), a.toolbar.on('click', E), a.toolbar.on('mousedown', D), b.disableResizeEditor || a.statusbar.on('mousedown', G));
      ...
      b.styleWithSpan && !e.isMSIE && setTimeout(function () {
    ...
    x = function (b, c) {
      ...
      b.find('.note-color-palette').each(function () {
        for (var b = a(this), c = b.attr('data-target-event'), e = [
          ...
          for (var h = d[f], i = [
          ], j = 0, k = h.length; k > j; j++) {
            var l = h[j];
            i.push(['<button type="button" class="note-color-btn" style="background-color:',
            l,
            ';" data-event="',
            c,
            '" data-value="',
